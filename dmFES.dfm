object FES: TFES
  ...
  object qryPlannerItem: TFDQuery
    ...
    UpdateOptions.KeyFields = 'InspectionOrderID'
    SQL.Strings = (
      '-- Planner Item'
      ...
      '     , [InspectionStatus].Caption AS StatusStr'
      ...
      '    LEFT JOIN [Customer]'
        ...
        '    LEFT JOIN [InspectionStatus] ON  [InspectionOrder].[Inspecti' +
        'onStatusID] = [InspectionStatus].[InspectionStatusID]'
      '    '
      'ORDER BY BOOKIN ASC;'
      '        '
      '        ')
    Left = 96
    Top = 208
    object qryPlannerItemInspectionOrderID: TFDAutoIncField
      FieldName = 'InspectionOrderID'
      Origin = 'InspectionOrderID'
      ProviderFlags = [pfInWhere, pfInKey]
    end
    object qryPlannerItemCreatedOn: TSQLTimeStampField
      FieldName = 'CreatedOn'
      Origin = 'CreatedOn'
    end
    object qryPlannerItemServiceInterval: TFloatField
      FieldName = 'ServiceInterval'
      Origin = 'ServiceInterval'
    end
    object qryPlannerItemLevelNum: TIntegerField
      FieldName = 'LevelNum'
      Origin = 'LevelNum'
    end
    object qryPlannerItemNotePortable: TWideStringField
      FieldName = 'NotePortable'
      Origin = 'NotePortable'
      Size = 128
    end
    object qryPlannerItemNoteElectrical: TWideStringField
      FieldName = 'NoteElectrical'
      Origin = 'NoteElectrical'
      Size = 128
    end
    object qryPlannerItemNoteWaterBase: TWideStringField
      FieldName = 'NoteWaterBase'
      Origin = 'NoteWaterBase'
      Size = 128
    end
    object qryPlannerItemNoteStructual: TWideStringField
      FieldName = 'NoteStructual'
      Origin = 'NoteStructual'
      Size = 128
    end
    object qryPlannerItemInspectionStatusID: TIntegerField
      FieldName = 'InspectionStatusID'
      Origin = 'InspectionStatusID'
    end
    object qryPlannerItemHRID: TIntegerField
      FieldName = 'HRID'
      Origin = 'HRID'
    end
    object qryPlannerItemIsArchived: TBooleanField
      FieldName = 'IsArchived'
      Origin = 'IsArchived'
      Required = True
    end
    object qryPlannerItemCustSiteID: TIntegerField
      FieldName = 'CustSiteID'
      Origin = 'CustSiteID'
    end
    object qryPlannerItemIsEnabled: TBooleanField
      FieldName = 'IsEnabled'
      Origin = 'IsEnabled'
      Required = True
    end
    object qryPlannerItemCustomerID: TIntegerField
      FieldName = 'CustomerID'
      Origin = 'CustomerID'
    end
    object qryPlannerItemSubject: TWideStringField
      FieldName = 'Subject'
      Origin = 'Subject'
      ReadOnly = True
      Required = True
    ...
    object qryPlannerItemRecurrency: TWideStringField
      FieldName = 'Recurrency'
      Origin = 'Recurrency'
      ReadOnly = True
      Size = 67
    end
    object qryPlannerItemMinTimeField: TSQLTimeStampField
      FieldName = 'MinTimeField'
      Origin = 'MinTimeField'
    end
    object qryPlannerItemMaxTimeField: TSQLTimeStampField
      FieldName = 'MaxTimeField'
      Origin = 'MaxTimeField'
    end
    object qryPlannerItemIsPinned: TBooleanField
      FieldName = 'IsPinned'
      Origin = 'IsPinned'
      Required = True
    end
    object qryPlannerItemSiteID: TIntegerField
      FieldName = 'SiteID'
      Origin = 'SiteID'
    end
    object qryPlannerItemModifiedOn: TSQLTimeStampField
      FieldName = 'ModifiedOn'
      Origin = 'ModifiedOn'
    end
    object qryPlannerItemModifiedBy: TIntegerField
      FieldName = 'ModifiedBy'
      Origin = 'ModifiedBy'
    end
    object qryPlannerItemStatusStr: TWideStringField
      FieldName = 'StatusStr'
      Origin = 'StatusStr'
      Size = 50
    end
    object qryPlannerItemBookIN: TSQLTimeStampField
      FieldName = 'BookIN'
      Origin = 'BookIN'
    end
    object qryPlannerItemBookOut: TSQLTimeStampField
      FieldName = 'BookOut'
      Origin = 'BookOut'
    end
    object qryPlannerItemNote: TWideStringField
      FieldName = 'Note'
      Origin = 'Note'
      OnGetText = qryPlannerItemNotesGetText
      OnSetText = qryPlannerItemNotesSetText
      Size = 128
    end
    object qryPlannerItemCaption: TWideStringField
      FieldName = 'Caption'
      Origin = 'Caption'
      Size = 64
    end
  ...
  object imgList32x32: TVirtualImageList
    Images = <
      item
        CollectionIndex = 30
