object FESButtons: TFESButtons
  ...
  object pnlHeader: TPanel
    ...
    object vimageLogo: TVirtualImage
      ...
      Width = 50
      Height = 50
      ImageCollection = imgcollectSwitchBoard
      ImageWidth = 0
      ImageHeight = 0
      ImageIndex = 0
  ...
  object imgcollectSwitchBoard: TImageCollection
    Images = <
      item
        Name = 'FES_512x512'
        SourceImages = <
  ...
  object actnmanSwitchBoard: TActionManager
    ActionBars = <
      item
        Items = <
          item
