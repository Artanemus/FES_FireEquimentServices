object FESCustAddress: TFESCustAddress
  ...
  object vimglistCustBusNum: TVirtualImageList
    Images = <
      item
        CollectionIndex = 0
        CollectionName = 'pin'
    ...
    ImageCollection = imgcollCustBusNum
    Width = 32
    Height = 32
    Left = 312
    Top = 208
  end
  object pumenuCustBusNum: TPopupMenu
    Images = vimglistCustBusNum
    Left = 312
    Top = 272
  ...
  object BindingsList1: TBindingsList
    ...
    object LinkGridToDataSourceBindSourceDB1: TLinkGridToDataSource
      ...
      GridControl = ctrllistCustBusNum
      Columns = <>
    end
