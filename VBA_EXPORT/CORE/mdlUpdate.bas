...
Private Function Update_Process_C(dblServiceInterval As Double) As Boolean
    ...
    If (WarnErr = 0) Then
        ...
        ' NOTE: LinkData.LastAssignedTechnician is valid HRID else zero.
        mdlInspection.CreateInspectionOrder LinkData.CustSiteID, NextRequestedDT, dblServiceInterval, NextLevelNum, LinkData.LastAssignedTechnician
        If LinkData.IsNewCustomer Then
